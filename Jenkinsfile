...
// for display purpose
   ...
   //  git 'https://github.com/tataji251/GOL-Repo.git'
...
//}
  ...
  stage('Sonarqube') {
    ...
    stage('Deploy War') {
      steps {
          //deploy adapters: [tomcat8(credentialsId: 'tomcat-cred', path: '', url: 'http://13.58.244.224:8080/')], contextPath: null, war: '**/*.war'
